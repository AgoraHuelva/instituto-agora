...
export function FloatingWhatsApp() {
  const phoneNumber = "34644541705";
  const message = "Hola, me gustaría obtener más información sobre Instituto Ágora";
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex h-16 w-16 items-center justify-center rounded-full shadow-lg transition-transform hover:scale-110 hover:shadow-xl"
      aria-label="Contactar por WhatsApp"
    >
      <svg className="h-16 w-16" viewBox="0 0 1000 1000" xmlns="http://www.w3.org/2000/svg">
