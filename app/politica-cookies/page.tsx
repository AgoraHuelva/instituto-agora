  ...
  return (
    <main className="min-h-screen bg-background py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto font-light">
        ...
        <div className="prose prose-lg max-w-none text-foreground/80 space-y-6 [&_p]:mb-4">
          <section>
            <h2 className="text-2xl font-normal text-foreground mb-4 font-[family-name:var(--font-prata)]">
              ¿Qué son las cookies?
            </h2>
            <p>
              En inglés, el término &ldquo;cookie&rdquo; significa galleta, pero en el ámbito de la navegación web, una &ldquo;cookie&rdquo; es algo completamente distinto. Cuando accede a nuestro Sitio Web, en el navegador de su dispositivo se almacena una pequeña cantidad de texto que se denomina &ldquo;cookie&rdquo;. Este texto contiene información variada sobre su navegación, hábitos, preferencias, personalizaciones de contenidos, etc...
            </p>
            <p>
              Existen otras tecnologías que funcionan de manera similar y que también se usan para recopilar datos sobre tu actividad de navegación. Llamaremos &ldquo;cookies&rdquo; a todas estas tecnologías en su conjunto.
            </p>
            <p>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 mb-4">
              ...
              <li>Cambiar las preferencias de cookies desde la página <a href="https://centrodesintoxicacionagora.es/preferencias-de-cookies/">Personalizar Cookies</a>, a la que puede acceder desde el Aviso de Cookies o desde la página de <a href="https://centrodesintoxicacionagora.es/preferencias-de-cookies/">Personalizar Cookies</a>.</li>
              <li>Obtener información adicional en la página de <a href="https://centrodesintoxicacionagora.es/politica-de-cookies/">Política de Cookies</a>.</li>
            </ul>
            <p>
          ...
          <section>
            ...
            <div className="space-y-6 mt-6">
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-3 font-[family-name:var(--font-prata)]">
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-foreground mb-2">Publicitarias comportamentales:</h4>
                    <p>
          ...
          <section>
            ...
            <p>
              Puede gestionar sus preferencias de cookies en cualquier momento a través del panel de{" "}
